...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Fev-2025 às 00:05
...
(1, 'admin', 'admin', 'admin@gmail.com', 'rua admin', 1, 'Válido', 200.00),
(2, 'funcionario', 'funcionario', 'funcionario@gmail.com', 'rua funcionario', 2, 'Válido', 200.00);
